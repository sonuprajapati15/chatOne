...
public class Newsfr extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        String url = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=Indian News&maxResults=40&key=AIzaSyB7ug8gYDb0mbrd7pob8m7sUdAZESeahcI";
