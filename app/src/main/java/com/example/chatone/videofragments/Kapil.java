...
public class Kapil extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        text1.setText("More Video of Kapil");
    ...
    private void call1() {
        String url = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=kapil Award and sharma shows&maxResults=30&key=AIzaSyB7ug8gYDb0mbrd7pob8m7sUdAZESeahcI";
    ...
    private void call2() {
        String url = "https://www.googleapis.com/youtube/v3/search?part=snippet&q=the kapil sharma show&maxResults=40&key=AIzaSyB7ug8gYDb0mbrd7pob8m7sUdAZESeahcI";
